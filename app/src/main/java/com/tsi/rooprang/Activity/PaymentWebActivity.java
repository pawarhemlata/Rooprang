...
import com.tsi.rooprang.utility.Constants;
import com.tsi.rooprang.utility.LoadingDialog;
import com.tsi.rooprang.utility.RSAUtility;
...
//get rsa key method
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            LoadingDialog.showLoadingDialog(PaymentWebActivity.this, "Loading...");
...
////https://test.ccavenue.com/transaction.do
////https://pit.3dsecure.net/VbVTestSuiteService/pit1/acsService/paReq?summary=NDU1ZDUxYmQtODU2OS00Nzg0LWE5NzktYjMzZTFjNjBhOWZi
//https://test.ccavenue.com/receive/115/servlet/BankRespReceive?var1=309005896941
//            http://www.thelittleshoppers.com/HDFC_andriod/ccavResponseHandler.php
            try {
                String postData = AvenuesParams.ACCESS_CODE + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.ACCESS_CODE), "UTF-8") + "&" + AvenuesParams.MERCHANT_ID + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.MERCHANT_ID), "UTF-8") + "&" + AvenuesParams.ORDER_ID + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.ORDER_ID), "UTF-8") + "&" + AvenuesParams.REDIRECT_URL + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.REDIRECT_URL), "UTF-8") + "&" + AvenuesParams.CANCEL_URL + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.CANCEL_URL), "UTF-8") + "&" + AvenuesParams.WORKING_KEY + "=" + URLEncoder.encode(mainIntent.getStringExtra(AvenuesParams.WORKING_KEY), "UTF-8") + "&" + AvenuesParams.ENC_VAL + "=" + URLEncoder.encode(encVal, "UTF-8");
    ...
    public void show_alert(String msg) {
        AlertDialog alertDialog = new AlertDialog.Builder(
                PaymentWebActivity.this).create();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(PaymentWebActivity.this,MainActivity.class));
        finish();
    }
}
